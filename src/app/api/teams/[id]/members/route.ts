...
      const isTeamSupervisor = team.supervisors.some(supervisor => supervisor.id === user.id);
      
      if (!isTeamSupervisor) {
...
        supervisors: { select: { id: true, name: true, email: true } },
...
      }
    } else if (user.role === "SUPERVISOR") {
      const isSupervisor = team.supervisors.some(supervisor => supervisor.id === user.id);
      
      if (!isSupervisor) {
